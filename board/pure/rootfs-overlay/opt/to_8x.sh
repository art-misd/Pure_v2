...
cp -f /etc/asound.8x /etc/asound.conf
sed -i 's/serconfig=..--/serconfig=MMMM/' /boot/uEnv.txt
sed -i 's/snd_soc_davinci_mcasp.amanero_mute_delay=500 snd_soc_davinci_mcasp.amanero_mute_pins=8/snd_soc_davinci_mcasp.amanero_mute_pins=8/' /boot/uEnv.txt
